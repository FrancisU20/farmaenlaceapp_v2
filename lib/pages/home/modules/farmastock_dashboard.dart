...
class FarmastockDashboard extends StatefulWidget {
  const FarmastockDashboard({super.key});

  @override
  State<FarmastockDashboard> createState() => _FarmastockDashboard();
}

class _FarmastockDashboard extends State<FarmastockDashboard> {
  int pageIndex = 0;
